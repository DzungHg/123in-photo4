                    ...
                    <?php
                        ...
                        foreach($page->product_repeaters as $item) {
                            if($item->type == 'product_slides') {
                                ...
                                $imageLinkThumb = getImageUrlFromImages(page()->images, $item->product_slide_details->thumb_image_name);
                                $thumbImageStr .= "<img src='$imageLinkThumb' alt='$imageAltText'>\n";
                                //Làm tiếp hình lớn
                               
                                $imageLinkBig = getImageUrlFromImages($page->images, $item->product_slide_details->big_image_name);
