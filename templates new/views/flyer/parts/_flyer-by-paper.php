...
$paperCate = pages()->get("template=flyer-category, code_num=1"); //'1 là giấy danh mục ở đây: /suu-tap-danh-muc-san-pham/phan-loai-danh-thiep/
$flyerByPapers = pages()->get("/to-roi/")->children("flyer_categories=$paperCate");
?>
