 ...
 *    in Setup > Languages > each language, as needed.  {url}#promailer-form
 * 
 */
...
$emailBodyHTML = <<< _OUT
	<html><body>
		<p>{email_note}</p>
		<p><a href='{url}'><button style='font-size:larger'>{email_confirm}</button></a></p>
	</body></html>
_OUT;
...
$subscribeOptions = array(
	...
	'errorHoneypot' => __('Thank you for your subscription, welcome to the list.'), // pretend success
);
